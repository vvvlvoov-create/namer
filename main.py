...
def handle_message(update, context):
    ...
    # Реагируем ТОЛЬКО если пользователь в процессе заполнения
    ...
    # На все остальные текстовые сообщения НЕ реагируем
    # Бот будет молчать
...
def main():
    ...
    try:
        ...
        # Обработчик сообщений - реагирует ТОЛЬКО на процесс заполнения
